...
const enterpriseProducts = [
  ...
  },
  {
    ...
    purchasedControls: [
      ...
      { name: 'HSM keypair', purchased: 10, used: 2, remaining: 8, planIncluded: 6, addOnPurchased: 4 },
    ],
    includedResources: [
    ...
    for (const productId of productIds) {
      {
        ...
        const scaledInstances = base.instances.map(inst => {
          ...
          if (inst.dnsQueryCapacity) {
            scaledInst.dnsQueryCapacity = {
              ...inst.dnsQueryCapacity,
              used: scaleVal(inst.dnsQueryCapacity.used),
              remaining: inst.dnsQueryCapacity.purchased - scaleVal(inst.dnsQueryCapacity.used),
            }
          }
